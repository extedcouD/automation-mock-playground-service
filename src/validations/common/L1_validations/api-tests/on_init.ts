...
- All elements of $.context.domain must be in ["ONDC:RET10", "ONDC:RET11", "ONDC:RET12", "ONDC:RET13", "ONDC:RET14", "ONDC:RET15", "ONDC:RET16", "ONDC:RET18"]`,
                                            _debugInfo: {
                                                fedConfig: `
{"_NAME_":"CONTEXT_ENUM_DOMAIN","domain":["ONDC:RET10","ONDC:RET11","ONDC:RET12","ONDC:RET13","ONDC:RET14","ONDC:RET15","ONDC:RET16","ONDC:RET18"],"attr":"$.context.domain","_RETURN_":"attr all in domain","action":["on_init"]}
`,
                                            },
                                        },
                                    ];
...
- All elements of $.context.action must be in ["on_init"]`,
                                            _debugInfo: {
                                                fedConfig: `
{"_NAME_":"CONTEXT_ENUM_ACTION","attr":"$.context.action","_RETURN_":"attr all in action","action":["on_init"]}
`,
                                            },
                                        },
                                    ];
...
- All elements of $.context.core_version must be in ["1.2.0"]`,
                                            _debugInfo: {
                                                fedConfig: `
{"_NAME_":"CONTEXT_ENUM_VERSION","version":["1.2.0"],"attr":"$.context.core_version","_RETURN_":"attr all in version","action":["on_init"]}
`,
                                            },
                                        },
                                    ];
                    ...
                    return [
                        {
                            ...
                            _debugInfo: {
                                fedConfig: `
{"_NAME_":"CONTEXT_ENUM","_RETURN_":[{"_NAME_":"CONTEXT_ENUM_DOMAIN","domain":["ONDC:RET10","ONDC:RET11","ONDC:RET12","ONDC:RET13","ONDC:RET14","ONDC:RET15","ONDC:RET16","ONDC:RET18"],"attr":"$.context.domain","_RETURN_":"attr all in domain","action":["on_init"]},{"_NAME_":"CONTEXT_ENUM_ACTION","attr":"$.context.action","_RETURN_":"attr all in action","action":["on_init"]},{"_NAME_":"CONTEXT_ENUM_VERSION","version":["1.2.0"],"attr":"$.context.core_version","_RETURN_":"attr all in version","action":["on_init"]},{"_NAME_":"CONTEXT_REG_BAP_URI","attr":"$.context.bap_uri","reg":["^https?\\:\\/\\/"],"_RETURN_":"attr follow regex reg","action":["on_init"]},{"_NAME_":"CONTEXT_REG_BPP_URI","attr":"$.context.bpp_uri","reg":["^https?\\:\\/\\/"],"_RETURN_":"attr follow regex reg","search":["search"],"_CONTINUE_":"(action equal to search)","action":["on_init"]},{"_NAME_":"CONTEXT_REG_TTL","attr":"$.context.ttl","reg":["^P(?=\\\\d|T)(\\\\d+Y)?(\\\\d+M)?(\\\\d+W)?(\\\\d+D)?(T(?=\\\\d)(\\\\d+H)?(\\\\d+M)?(\\\\d+S)?)?$"],"optional_vars":["on_search","on_select","on_confirm","on_init","on_cancel","on_track","on_update"],"_CONTINUE_":"(action all in optional_vars)","_RETURN_":"attr follow regex reg","action":["on_init"]}]}
`,
                            },
                        },
                        ...subResults,
...
`,
        ...
        function ON_INIT_ORDER(input: validationInput): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, '$');
            let subResults: validationOutput = [];
            let valid = true;
            for (const testObj of scope) {
...
`,
                        ...
                        function TAGS_BPP_COLLECT(
                            ...
                            for (const testObj of scope) {
                                ...
                                function TAGS_BPP_COLLECT_SUCCESS(
                                    input: validationInput
                                ): validationOutput {
                                    const scope = payloadUtils.getJsonPath(
                                        input.payload,
                                    ...
                                    for (const testObj of scope) {
                                        ...
                                        const attr = payloadUtils.getJsonPath(
                                            testObj,
                                            "$.message.order.payment.tags[?(@.code=='bpp_collect')].list[?(@.code=='success')].value",
                                            true
                                        );
                                        const var_enum = ['Y', 'N'];
...
`,
                                ...
                                function TAGS_BPP_COLLECT_ERROR(
                                    input: validationInput
                                ): validationOutput {
                                    const scope = payloadUtils.getJsonPath(
                                        input.payload,
                                    ...
                                    for (const testObj of scope) {
                                        ...
                                        const attr = payloadUtils.getJsonPath(
                                            testObj,
                                            "$.message.order.payment.tags[?(@.code=='bpp_collect')].list[?(@.code=='error')].value",
                                            true
                                        );
                                        const var_enum = ['Y', 'N'];
...
`,
                        ...
                        function OFFERS_DESCRIPTOR_CODE(
                            input: validationInput
                        ): validationOutput {
                            const scope = payloadUtils.getJsonPath(
                                input.payload,
                            ...
                            for (const testObj of scope) {
                                ...
                                const attr = payloadUtils.getJsonPath(
                                    testObj,
                                    '$.message.order.offers[*].descriptor.code',
                                    true
                                );
                                const var_enum = [
                                    'discount',
...
`,
                        ...
                        function OFFERS_DESCRIPTOR_IMAGES(
                            input: validationInput
                        ): validationOutput {
                            const scope = payloadUtils.getJsonPath(
                                input.payload,
                            ...
                            for (const testObj of scope) {
                                ...
                                const attr = payloadUtils.getJsonPath(
                                    testObj,
                                    '$.message.order.offers[*].descriptor.images[*]',
                                    true
                                );
                                    ...
                                    return [
                                        {
                                            ...
                                            valid: false,
                                            code: 30000,
                                            description: `#### **OFFERS_DESCRIPTOR_IMAGES**
...
`,
                            ...
                            return [
                                {
                                    testName: 'OFFERS_DESCRIPTOR_IMAGES',
                                    valid: valid,
                                    code: valid ? 200 : 30000,
                                    _debugInfo: {
                                        fedConfig: `
...
`,
                        ...
                        function OFFERS_LOCATION_IDS(
                            ...
                            for (const testObj of scope) {
                                ...
                                const attr = payloadUtils.getJsonPath(
                                    testObj,
                                    '$.message.order.offers[*].location_ids[*]',
                                    true
                                );
                                ...
                                if (!validate) {
                                    ...
                                    return [
                                        {
                                            testName: 'OFFERS_LOCATION_IDS',
                                            valid: false,
                                            code: 30000,
                                            description: `#### **OFFERS_LOCATION_IDS**
                        ...
                        function OFFERS_ITEM_IDS(
                            ...
                            for (const testObj of scope) {
                                ...
                                if (!validate) {
                                    ...
                                    return [
                                        {
                                            testName: 'OFFERS_ITEM_IDS',
                                            valid: false,
                                            code: 30000,
                                            description: `#### **OFFERS_ITEM_IDS**
...
`,
                        ...
                        function OFFERS_TIME_LABEL(
                            ...
                            for (const testObj of scope) {
                                ...
                                const attr = payloadUtils.getJsonPath(
                                    testObj,
                                    '$.message.order.offers[*].time.label',
                                    true
                                );
                                ...
                                if (!validate) {
                                    ...
                                    return [
                                        {
                                            testName: 'OFFERS_TIME_LABEL',
                                            valid: false,
                                            code: 30000,
                                            description: `#### **OFFERS_TIME_LABEL**
...
`,
                        ...
                        function OFFERS_TIME_RANGE_START(
                            input: validationInput
                        ): validationOutput {
                            const scope = payloadUtils.getJsonPath(
                                input.payload,
                            ...
                            for (const testObj of scope) {
                                ...
                                const attr = payloadUtils.getJsonPath(
                                    testObj,
                                    '$.message.order.offers[*].time.range.start',
                                    true
                                );
                                ...
                                if (!validate) {
                                    ...
                                    return [
                                        {
                                            testName: 'OFFERS_TIME_RANGE_START',
                                            valid: false,
                                            code: 30000,
                                            description: `#### **OFFERS_TIME_RANGE_START**
...
`,
                        ...
                        function OFFERS_TIME_RANGE_END(
                            input: validationInput
                        ): validationOutput {
                            const scope = payloadUtils.getJsonPath(
                                input.payload,
                            ...
                            for (const testObj of scope) {
                                ...
                                const attr = payloadUtils.getJsonPath(
                                    testObj,
                                    '$.message.order.offers[*].time.range.end',
                                    true
                                );
                                ...
                                if (!validate) {
                                    ...
                                    return [
                                        {
                                            testName: 'OFFERS_TIME_RANGE_END',
                                            valid: false,
                                            code: 30000,
                                            description: `#### **OFFERS_TIME_RANGE_END**
